...
export default async function PlayersPage() {
  ...
  const streakByPlayer = new Map<string, { wins: number; losses: number; duelWins: number }>();
  ...
  if (playerIds.length > 0) {
    try {
      ...
      for (const playerId of playerIds) {
        ...
        streakByPlayer.set(playerId, { wins: perf.rankedWinStreak, losses: perf.rankedLossStreak, duelWins: perf.rankedDuelWins });
